   	...
   	<div class="span12">
   		<div class="form-inline">
   			<fieldset>   				
		   		...
		   		<!-- 
		   		<input class="btn btn-success" type="button" onclick="createDdlChannel('<%=path %>/ddl')" value="新增"></td>
   			...
   			<div id="dataList">
		    	...
		    	<s:iterator value="ddlChannelVOList">  
		    		...
		    		<td>
						...
						<a class="btn btn-primary" href="javascript: modifyDdlChannel('<%=path%>/ddl','<s:property value="id"/>')" title="修改">
						修改
						</a>
