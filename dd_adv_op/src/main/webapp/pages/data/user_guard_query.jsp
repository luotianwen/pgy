	...
	<div class="span12">
		...
		<div class="widget-box">
      		...
      		<tr><td>请选择时间<font color="red">*</font></td>
				...
				<td>被守护插件ID</td>
				<td>
					<s:select list="#Option.guardPluginIdList" listKey="apkId" listValue="note" id="guardPluginId" name="searchVO.guardPluginId" cssClass="selectWidth" headerKey="0" headerValue="--所有插件--"></s:select>
				</td>
				</tr>
...
<script type="text/javascript">
	...
	$("#guardPluginId").select2();
	$("#bdId").select2();
	if($("#projectId")) {
		$("#projectId").select2();
	}
	function searchList() {
		var url="<%=request.getContextPath()%>/data/UserGuard!list.action";
		if($("#start").val() == "") {
		...
		var guardPluginId =  $("#guardPluginId").val();
		var bdId =$("#bdId").val();
		...
		jQuery.post(url,{"searchVO.startDate":startDate,
			...
			"searchVO.guardPluginId":guardPluginId,
			"searchVO.bdId":bdId,
