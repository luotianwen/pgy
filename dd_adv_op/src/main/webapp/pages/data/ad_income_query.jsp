	        	...
	        	<tr >	
  				...
  				<tr><td>统计显示列<font color="red">*</font></td>
					<td>		
						...
						<label class="checkbox-inline">
						<input type="checkbox" name="searchVO.rowFields" value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_AD" />" checked="checked"/>广告
						</label>
					</td></tr>
...
<script type="text/javascript">
	$("#adId").select2();
	function searchList() {
		var url="<%=request.getContextPath()%>/data/AdIncome!list.action";
		if($("#start").val() == "") {
