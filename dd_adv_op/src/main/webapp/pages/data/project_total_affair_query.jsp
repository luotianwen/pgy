...
<script type="text/javascript">
	...
	function searchList() {
		var url="<%=request.getContextPath()%>/data/ProjectData!totalaffairList.action";
		if($("#start").val() == "") {
	...
	function exportData() {
		...
		exportForm.action="<%=request.getContextPath()%>/data/ProjectData!exportTotalList.action";
		if($("#start").val() == "") {
			showInfoToastMiddle("请选择开始时间");
			$("#start").focus();
			return false;
