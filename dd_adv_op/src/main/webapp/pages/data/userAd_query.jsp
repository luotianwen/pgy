		...
		<div class="widget-box">
      		...
      		<tr><td>请选择时间<font color="red">*</font></td>
				...
				<tr >	
					<td>类型</td>
					<td >
						<s:select list="#{'1':'push','2':'插屏',3:'线下'}" listKey="key" listValue="value" id="type" name="searchVO.type" cssClass="selectWidth" headerKey="0" headerValue="--所有类型--"></s:select>
  					</td>
  				</tr>
...
<script type="text/javascript">
	...
	$("#type").select2();
	function searchList() {
		var url="<%=request.getContextPath()%>/data/UserAdData!list.action";
		if($("#start").val() == "") {
