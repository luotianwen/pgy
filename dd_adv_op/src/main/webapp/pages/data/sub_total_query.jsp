            ...
            <form class="form-horizontal" id="exportForm">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="searchVO.startDate" id="start" onfocus="javascript:WdatePicker()"
                    ...
                    <tr>
                            <td>广告</td>
                            <td>
                                <select id="adId" name="searchVO.adId" class="selectWidth">
                                    <s:action name="getAllSubscribeList" namespace="/adver" executeResult="true">
                                    </s:action>
                                </select>
                            </td>
                        </tr>
                    <tr>
                        ...
                        <td>国家</td>
                        <td>
                            <s:select list="#Option.countryList" listKey="id" listValue="name"
                                      id="country" name="searchVO.country" cssClass="selectWidth" headerKey="0" headerValue="--所有国家--"></s:select>
                        </td>
                    </tr>
                    <tr>
                        <td>广告类型</td>
                        <td>
                            <s:select id="subType" list="#Option.subType" listKey="key" listValue="value"
                                      ...
                                      headerValue="--所有类型--"></s:select>
                        </td>
                    </tr>
                    <tr>
                        <td>平台</td>
                        <td>
                            <s:select id="platformId" list="#Option.platformList" listKey="id" listValue="name"
                                      cssClass="selectWidth" headerKey="0" headerValue="--所有平台--"></s:select>
                        </td>
                    </tr>
                    <tr>
                        <td>运营商</td>
                    ...
                    <tr>
                        <td>渠道</td>
                        <td>
                            <s:select id="customerId" list="#Option.pcustomerList" listKey="id" listValue="name"
                                      headerKey="0" headerValue="--所有渠道--" cssClass="selectWidth"></s:select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                                       value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_AD" />"/>广告
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                                       value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_TYPE" />"/>广告类型
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                                       value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_OPERATOR" />"/>运营商
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                                       value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_PLATFORM" />"/>平台
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                                       value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_COUNTRY" />"/>国家
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                                       value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_PROJECT" />"/>渠道
                            </label>
                        </td>
                    </tr>
                    <tr>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="widget-box" id="dataList">
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $("#customerId").select2();
    function searchList() {
        var url = "<%=request.getContextPath()%>/data/SubData!totalList.action";
        if ($("#start").val() == "") {
        ...
        if ('undefined' == typeof(platformId)) {
            platformId = 0;
        }
        ...
        jQuery.post(url, {
                    ...
                    "searchVO.operator": operator,
                    "searchVO.platformId": platformId,
    ...
    function exportData() {
        ...
        exportForm.action = "<%=request.getContextPath()%>/data/SubData!exportTotalList.action";
        if ($("#start").val() == "") {
            showInfoToastMiddle("请选择开始时间");
            $("#start").focus();
            return false;
