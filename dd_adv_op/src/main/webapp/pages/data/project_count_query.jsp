...
<script type="text/javascript">
	...
	function searchList() {
		var url="<%=request.getContextPath()%>/data/ProjectData!projectTotalList.action";
		if($("#startTime").val() == "") {
		...
		jQuery.post(url,{"searchVO.startTime":startTime,
	...
	function exportData() {
		...
		exportForm.action ="<%=request.getContextPath()%>/data/ProjectData!exportTotal.action";
		if($("#startTime").val() == "") {
			showInfoToastMiddle("请选择项目创建开始时间");
			$("#startTime").focus();
			return false;
