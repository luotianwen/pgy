            ...
            <form class="form-horizontal" id="exportForm">
                ...
                <table class="table">
                    ...
                    <tr>
                            ...
                            <td>
                                <select id="adId" name="searchVO.adId" class="selectWidth">
                                    <s:action name="getAllIframeList" namespace="/offerinfo" executeResult="true">
                                    </s:action>
                                </select>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td>运营商</td>
                        <td>
                            <select id="operatorId" name="iframeVO.operatorId" class="selectWidth" >
...
<script type="text/javascript">
    ...
    $("#project").select2()
    function searchList() {
        var url = "<%=request.getContextPath()%>/data/IframeData!totalList.action";
        if ($("#start").val() == "") {
