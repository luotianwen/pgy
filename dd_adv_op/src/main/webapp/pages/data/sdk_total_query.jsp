            ...
            <form class="form-horizontal" id="exportForm">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <s:select list="#Option.countryList" listKey="id" listValue="name" id="country"
                                      name="searchVO.country" cssClass="selectWidth" headerKey="0"
                    ...
                    <tr>
                        <td>类型</td>
                        <td>
                            <s:select list="#Option.promotionType" listKey="key" listValue="value" id="type"
                                      name="searchVO.type" cssClass="selectWidth" headerKey="0"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="checkbox-inline">
                            <input type="checkbox" name="searchVO.rowFields" value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_AD" />"/>广告
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="searchVO.rowFields"
                            ...
                            <%--<label class="checkbox-inline">--%>
                                <%--<input type="checkbox" name="searchVO.rowFields"--%>
                                       <%--value="<s:property value="@com.kkgame.feeop.data.bean.RowFieldVO@ROW_FIELD_TYPE" />"/>类型--%>
                            <%--</label>--%>
                        </td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    ...
    //	}
    function searchList() {
        var url = "<%=request.getContextPath()%>/data/SdkData!totalList.action";
        if ($("#start").val() == "") {
    ...
    function exportData() {
        ...
        exportForm.action = "<%=request.getContextPath()%>/data/SdkData!exportTotalList.action";
        if ($("#start").val() == "") {
            showInfoToastMiddle("请选择开始时间");
            $("#start").focus();
            return false;
