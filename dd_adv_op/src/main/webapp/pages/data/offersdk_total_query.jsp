            ...
            <form class="form-horizontal" id="exportForm">
                ...
                <table class="table">
                    ...
                    <tr>
                            ...
                            <td>
                                <select id="adId" name="searchVO.adId" class="selectWidth">
                                    <s:action name="getAllOfferSdkList" namespace="/offerinfo" executeResult="true">
                                    </s:action>
                                </select>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td>广告类型</td>
                        <td>
                            <s:select id="subType" list="#Option.offerSdkList" listKey="key" listValue="value"
                                      name="offerSdkVO.type" cssClass="selectWidth" headerKey="0"
                    ...
                    <tr>
                        <td>项目</td>
                        <td>
                            <select id="project" name="searchVO.projectId" class="selectWidth">
                    ...
                    <tr>
                        <td>运营商</td>
                        <td>
                            <select id="operatorId" name="offerSdkVO.operatorId" class="selectWidth" >
...
<script type="text/javascript">
    ...
    $("#project").select2()
    function searchList() {
        var url = "<%=request.getContextPath()%>/data/OfferSdkData!totalList.action";
        if ($("#start").val() == "") {
