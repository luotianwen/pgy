   			...
   			<div id="dataList">
				...
				<td colspan="7">
					<div class="pagelist" id="pagelist1" align="right">
						<page:paginationAjax formName="ApkInfoForm" property="sdkProjectVO.page" operation="/sdkinfo/SdkProject!list.action"/>
 					</div>					
				</td>
				</tr>
				</tbody>
...
<script type="text/javascript">		
	...
	function searchList() {
		...
		var url = "<%=request.getContextPath()%>/sdkinfo/SdkProject!list.action";
		jQuery.post(url,
	...
	function modifySdkProject(path,id) {
		$('body').modalmanager('loading');
		  setTimeout(function(){
	  		$modal.load(path+'/SdkProject!modify.action', {"sdkProjectVO.id":id}, function(){
	     		$modal.modal();
	    	});
		  }, 100);
	}
	function createSdkProject(path) {
		$('body').modalmanager('loading');
		  setTimeout(function(){
	  		$modal.load(path+'/SdkProject!create.action', {}, function(){
	     		$modal.modal();
	    	});
		  }, 100);
	}
