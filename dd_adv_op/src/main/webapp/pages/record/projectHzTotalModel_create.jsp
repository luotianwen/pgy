...
<s:hidden id="cid" name="projectHzTotalModelVO.id"/>
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h2>导入项目数据（新增/修改）</h2>
    <font color="red">&nbsp;&nbsp;&nbsp;&nbsp;一次只能上传一天的数据，重复上传将覆盖同一天的数据</font>
</div>
...
<script type="text/javascript">
    ...
    function ajaxFileUpload() {
        ...
        $.ajaxFileUpload({
            url: '<%=path%>/record/ProjectHzTotalModel!save.action',//用于文件上传的服务器端请求地址
