...
<script type="text/javascript">
	function searchList() {
		...
		url = "<%=request.getContextPath()%>/detail/SdkUsersModel!projectValidlist.action";
		jQuery.post(url,{"sdkUsersModelVO.cooId":id,"sdkUsersModelVO.cdate":name,"sdkUsersModelVO.isPage":1},function(response){
			if(response=="-1") {
