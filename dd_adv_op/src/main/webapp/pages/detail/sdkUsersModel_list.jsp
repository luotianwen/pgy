...
<script type="text/javascript">
	function searchList() {
		...
		url = "<%=request.getContextPath()%>/detail/SdkUsersModel!list.action";
		jQuery.post(url,{"sdkUsersModelVO.imei":id,"sdkUsersModelVO.cdate":name,"sdkUsersModelVO.cooId":coo_id,"sdkUsersModelVO.sdkversion":sdkversion,"sdkUsersModelVO.isPage":1,"sdkUsersModelVO.type":"${sdkUsersModelVO.type}"
		},function(response){
			if(response=="-1") {
