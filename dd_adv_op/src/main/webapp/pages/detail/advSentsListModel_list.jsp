...
<s:if test="advSentsListModelVO.isPage==0">
   		...
   		<div class="form-inline">
            ...
            <label class="control-label inline" for="pname">imei</label>
                 ...
                 <label class="control-label inline" for="pname"> 时间</label>
                  <input type="text" name="qname" id="qname" onfocus="javascript:WdatePicker()" value="${advSentsListModelVO.cdate}" readonly="readonly"   style="width:150px;">
  	...
  	<form class="form-horizontal" id="dataForm">
  		<fieldset>
   			<div id="dataList">
				...
				<tbody>
		    	<s:iterator value="advSentsListModelVOList">  
		    		<tr >
...
<script type="text/javascript">		
	...
	function searchList() {
		...
		url = "<%=request.getContextPath()%>/detail/AdvSentsListModel!list.action";
		jQuery.post(url,{"advSentsListModelVO.imei":id,"advSentsListModelVO.coo_id":coo_id,"advSentsListModelVO.sdkversion":sdkversion,"advSentsListModelVO.cdate":name,"advSentsListModelVO.isPage":1
		},function(response){
			if(response=="-1") {
