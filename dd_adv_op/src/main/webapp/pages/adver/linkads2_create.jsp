...
<s:hidden id="cid" name="linkads2VO.id"/>
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	<h2>
		<s:if test="linkads2VO.id==0">新建链接广告</s:if>
		<s:if test="linkads2VO.id>0">修改链接广告</s:if>
	</h2>
</div>
	...
	<form class="form-horizontal" style="margin: 0px;">
		<table class="table">
			<tr>
				...
				<td>
					<input id="name" type="text"  class="input-medium" name="linkads2VO.name"
						   value="${linkads2VO.name}"/>

				</td>
				<td class="table_td_title">接入人员</td>
				<td>
					<s:select id="advLinkmanId" list="#Option.advLinkmanList" listKey="id" listValue="name" name="linkads2VO.advLinkmanId"
			...
			<tr>
				...
				<td colspan="3">
					<input id="redirectUrl" type="text" size="100" class="input-medium" name="linkads2VO.redirectUrl"
						   value="${linkads2VO.redirectUrl}"/>
				</td>
			</tr>
			<tr>
				<td class="table_td_title">广告主</td>
				<td>
					<s:select id="adverId" list="#Option.adverList" listKey="id" listValue="name" name="linkads2VO.adverId"
				...
				<td>
					<s:select id="status" list="#Option.selectList" listKey="key" listValue="value"
							  name="linkads2VO.status" cssClass="selectWidth"></s:select>

				</td>
			</tr>
			<tr>
				<td class="table_td_title">链接类型</td>
				<td>
					<s:select id="linkType" headerValue="1" list="#Option.linkType" listKey="key"
							  listValue="value" name="linkads2VO.linkType" cssClass="selectWidth"></s:select>
				</td>
				<td class="table_td_title">网络类型</td>
				<td>
					<s:select id="linkAdType" headerValue="1" list="#Option.netType" listKey="key"
							  listValue="value" name="linkads2VO.linkAdType" cssClass="selectWidth"></s:select>
				</td>
			</tr>
			<tr>
				<td class="table_td_title">推广类型</td>
				<td>
					<s:select id="clickType" headerValue="3200" list="#Option.clickType" listKey="key" listValue="value"
							  name="linkads2VO.clickType" cssClass="selectWidth"></s:select>

				</td>

				<td class="table_td_title">运营商</td>
				<td>
					<s:select id="operator" list="#Option.operator" listKey="key" listValue="value" name="linkads2VO.operator"
							  cssClass="selectWidth"></s:select>
			...
			<tr>
				...
				<td>
					<input id="cap" type="text" class="input-medium" name="linkads2VO.cap" value="${linkads2VO.cap}"/>

				</td>
				<td class="table_td_title" style="color:red">cpm</td>
				<td>
					<input id="cpm" type="text" class="input-medium" name="linkads2VO.cpm"
						   value="${linkads2VO.cpm}"/>
			...
			<tr>
				...
				<td colspan="3">
					<textarea rows="2" cols="100" id="notes">${linkads2VO.notes}</textarea>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4">
					<input id="createBtn" type="button" class="btn btn-primary" value="确 定"
						   onclick="javascript:updatelinkads2('<%=path %>');">
				</td>
			</tr>
		</table>
	</form>
...
<script type="text/javascript">
	...
	var country = '<s:property value="linkads2VO.countryIds"/>';
