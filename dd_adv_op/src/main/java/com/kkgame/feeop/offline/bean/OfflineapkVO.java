 ...
 * @since 3.0
 */
public class OfflineapkVO extends BasicVO{
    private int id;
    private String url;
    private int version;
    ...
    public int getInstallClock() {
        return installClock;
    }

    public void setInstallClock(int installClock) {
        this.installClock = installClock;
    }
}
