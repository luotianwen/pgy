 ...
 * @since 3.0
 */
public class OfferSdkDataDAOImpl extends SqlMapClientDaoSupport implements OfferSdkDataDAO {
    @Override
    public List<SubDataVO> getTotalOfferSdkDataVOList(SearchVO searchVO) {
        ...
        return getSqlMapClientTemplate().queryForList("offerSdkDataSqlMap.getOfferSdkDataVOList", searchVO);
    }
}
