...
public class VersionDataDAOImpl extends SqlMapClientDaoSupport implements
		VersionDataDAO {
	...
	public List<VersionDataVO> getVersionDataVOList(SearchVO searchVO)
		...
		return getSqlMapClientTemplate().queryForList("versionDataSqlMap.getVersionDataVOList", searchVO);
	}
}
