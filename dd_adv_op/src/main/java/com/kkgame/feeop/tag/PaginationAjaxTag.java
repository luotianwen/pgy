...
public class PaginationAjaxTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			sb.append("			jQuery.post(\"").append(ServletActionContext.getRequest().getContextPath()).append(operation).append("\",").append(strCR);;
			...
			sb.append("&nbsp;&nbsp;&nbsp;<input class=\"input-mini-important\" onkeyup=\"this.value=this.value.replace(/[^\\d]/g,'');\" type = \"text\" id = \"pageNum").append("\" name = \"pageNum")
