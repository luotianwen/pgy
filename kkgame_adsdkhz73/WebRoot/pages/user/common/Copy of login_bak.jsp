	      ...
	      <div>
		        ...
		        <div class="login_middle">
		        	<table width="100%">
		        		<tr>
		        			<td>
		        				<input id="loginId" name="portalUserVO.loginId" style="margin-top: 105px;margin-left: 390px;height: 42px;" type="text" class="input-login" >
		        			</td>
		        		</tr>
		        		<tr>
		        			<td>
		        				<input id="passwd" name="portalUserVO.passwd" style="margin-top: 7px;margin-left: 390px;height: 42px;" type="password" class="input-login">
		        				</td>
		        		</tr>
		        		<tr>
		        			<td>
