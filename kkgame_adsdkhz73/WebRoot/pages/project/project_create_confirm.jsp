...
<s:bean id="Policy" name="com.kkgame.hz.tag.Policy"/>
	...
	<table class="table">
		...
		<tr >
			...
			<td>
				<input type="text" class="input-small" id="cuDividePercent_<s:property value="id"/>" name="productVOList[<s:property value="#stat.index"/>].cuDividePercent" value="<s:property value="cuDividePercent"/>" size="5"	onkeyup="this.value=this.value.replace(/[^\d.]/g,'');" onblur="changeBdPrice(3,'<s:property value="id"/>',1);"/>%&nbsp;比例范围：(<font color="red">0-<s:property value="cuDividePercent"/></font>)
			</td>
		</tr>
		<tr>
			<td>商务拓展人员</td>
		...
		<tr >
		    <td  colspan="4">
			<div align="center">				
			   <input id="btn" class="btn btn-primary" type="button" value=" 创 建 " onclick="projectSave();"/>&nbsp;&nbsp;
		    </div>
			</td>
		</tr>
	</table>
...
function projectSave(){
	...
	var url = "<%=request.getContextPath()%>/Project!save.action";
