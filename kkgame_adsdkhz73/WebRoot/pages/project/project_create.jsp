...
<form id="projectForm" class="form-horizontal" >
	<table class="table">
		...
		<tr >
			...
			<td colspan="3">
				<s:iterator value="bhList" status="bhStat">
					<label class="checkbox" for="bh_<s:property value="id"/>">					
					<input type="radio" id="bh_<s:property value="id"/>" name="businessHelperId"  value="<s:property value="id"/>" /><s:property value="name"/>
					</label>
		...
		<tr >
            ...
            <td colspan="3">
				<input type="radio" value="1" name="projectVO.type"  checked="checked"/>&nbsp;广告SDK&nbsp;&nbsp;				
		...
		<tr>
            ...
            <td><input type="text" class="input-medium" id="gameName" name="projectVO.gameName" /></td>
            <td class="table_td_title">SDK<font color="red">*</font></td>			 
            <td><input type="text" class="input-medium" id="feeName" name="projectVO.feeName"/></td>
		</tr>
		<!-- 
		<tr>
            ...
            <td colspan="3">
            	...
            	<s:select id ="big" list="#Policy.bigList" listKey="key" listValue="value" name="projectVO.big" cssStyle="width:215px;"></s:select>
            </td>
		</tr>
		<tr >
			<td class="table_td_title">是否去掉LOGO<font color="red">*</font></td>			 
            <td colspan="3">
				<input type="radio" value="0" name="projectVO.isRemoveLogo" />&nbsp;是&nbsp;&nbsp;				
				<input type="radio" value="1" name="projectVO.isRemoveLogo" checked="checked"/>&nbsp;否
			</td>
		</tr>		
		<tr >
			<td class="table_td_title">机型价格</td>			 
            <td colspan="3">
				<s:select list="#Policy.priceList" id="price" name="projectVO.price" listKey="key" listValue="value" headerKey="0" headerValue="--请选择预计价格--" cssStyle="width: 150px"></s:select>
			</td>
		</tr>	 -->
		<tr >
...
function VerifyData(status){
    ...
    var url = "<%=request.getContextPath()%>/Project!createCooperateInput.action";
