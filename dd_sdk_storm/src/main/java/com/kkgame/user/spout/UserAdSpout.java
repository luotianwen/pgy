...
public class UserAdSpout
  implements IRichSpout
{
  private static final long serialVersionUID = -6260803932233430770L;
  private static final Logger LOG = LoggerFactory.getLogger(UserAdSpout.class);
  ...
  public void emit() {
    try {
      ...
      try { String userInfoRedis = jedis.rpop("user_ad");
  ...
  {
    declarer.declare(new Fields(new String[] { "id", "UserAd" }));
  }
