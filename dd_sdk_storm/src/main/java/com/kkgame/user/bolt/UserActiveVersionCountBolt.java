...
public class UserActiveVersionCountBolt
  implements IRichBolt
{
  private static final long serialVersionUID = -3439373559433010227L;
  private static final Logger LOG = LoggerFactory.getLogger(UserActiveVersionCountBolt.class);
  ...
  public void execute(Tuple input)
  {
    ...
    sb.append("user_active_project_version_stat").append("_");
    sb.append(statDate);
    ...
    try {
      ...
      try { jedis.zincrby(sb.toString(), 1.0D, versionSb.toString());
        ...
        if (userVO.getDataType() == 1) {
          sb = new StringBuffer();
          sb.append("user_active_version_stat").append("_");
          sb.append(statDate);
          sb.append("_").append(sdkStyle);
