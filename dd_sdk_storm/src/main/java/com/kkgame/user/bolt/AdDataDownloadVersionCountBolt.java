...
public class AdDataDownloadVersionCountBolt
  implements IRichBolt
{
  private static final long serialVersionUID = -1910988498868909130L;
  private static final Logger LOG = LoggerFactory.getLogger(AdDataDownloadVersionCountBolt.class);
  ...
  public void execute(Tuple input)
  {
    ...
    sb.append("adData_download_version_stat_times").append("_");
    sb.append(statDate);
    ...
    try {
      ...
      try { jedis.zincrby(sb.toString(), 1.0D, versionSb.toString());
        ...
        if (adDataVO.getIsVersionRepeat() == 1) {
          sb = new StringBuffer();
          sb.append("adData_download_version_stat_users").append("_");
          sb.append(statDate);
          sb.append("_").append(adType);
  ...
  private boolean isVersionRepeat(AdDataVO adDataVO, boolean flag) {
    ...
    try { Jedis jedis = this.jedisPool.getResource(); 
      try { StringBuffer sb = new StringBuffer();
        sb.append("adData_download_version_detail").append("_").append(statDate).append("_").append(sdkStyle).append("_").append(sdkVersion).append("_").append(adType).append("_").append(imei);
