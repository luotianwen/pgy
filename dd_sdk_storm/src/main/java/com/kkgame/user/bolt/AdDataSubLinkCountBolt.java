...
public class AdDataSubLinkCountBolt
        implements IRichBolt {
    private static final long serialVersionUID = -5573683060557415895L;
    private static final Logger LOG = LoggerFactory.getLogger(AdDataSubLinkCountBolt.class);
    ...
    public void execute(Tuple input) {
        SubLinkVO subLinkVO = (SubLinkVO) input.getValueByField("SubLink");
        String cou = subLinkVO.getCou();
        String cdate = subLinkVO.getCdate();
        String xmodel = subLinkVO.getXmodel();
        String xoperator = subLinkVO.getXoperator();
        String xversion = subLinkVO.getXversion();
        long clickId = subLinkVO.getClickId();
        int adId = subLinkVO.getAdId();
        int projectId = subLinkVO.getCooid();
//        int internet = subLinkVO.getInternet();
        String agent = subLinkVO.getUserAgent();
        String clickIp= subLinkVO.getClickIp();
        String clickReferer = subLinkVO.getReferer();
        String brand = subLinkVO.getXbrand();
        String browser = subLinkVO.getXbrowser();
        int height = subLinkVO.getXheight();
        int width = subLinkVO.getXwidth();
        String os = subLinkVO.getOs();
        int adType = subLinkVO.getAdType();
        String device = subLinkVO.getDevice();
        int platformId = subLinkVO.getPlatId();
...
//        jsonObject.put("internet", internet);
        ...
        jsonObject.put("ipaddr", clickIp);
        jsonObject.put("clickReferer", clickReferer);
