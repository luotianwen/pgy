...
public class UserAdBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = 819599923097758486L;
  private static final Logger LOG = Logger.getLogger(UserAdBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof UserVO)) {
      ...
      collector.emit("userAd_count_stream", new Values(new Object[] { tupleId, userVO }));
    }
    else if (obj != null) {
  ...
  {
    declarer.declareStream("userAd_count_stream", new Fields(new String[] { "id", "UserInfo" }));
  }
