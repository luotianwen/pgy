...
public class UserInfoCountBolt
  implements IRichBolt
{
  private static final long serialVersionUID = -5573683060557415895L;
  private static final Logger LOG = LoggerFactory.getLogger(UserInfoCountBolt.class);
  ...
  public void execute(Tuple input)
  {
    ...
    sb.append("user_info_stat").append("_");
    sb.append(statDate);
