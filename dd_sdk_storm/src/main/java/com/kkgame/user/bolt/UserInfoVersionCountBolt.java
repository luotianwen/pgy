...
public class UserInfoVersionCountBolt
  implements IRichBolt
{
  private static final long serialVersionUID = -6954154742438789569L;
  private static final Logger LOG = LoggerFactory.getLogger(UserInfoVersionCountBolt.class);
  ...
  public void execute(Tuple input)
  {
    ...
    sb.append("user_info_version_stat").append("_");
    sb.append(statDate);
