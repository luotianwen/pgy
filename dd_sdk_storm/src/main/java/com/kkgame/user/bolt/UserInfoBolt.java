...
public class UserInfoBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = 5463945569834197697L;
  private static final Logger LOG = Logger.getLogger(UserInfoBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof UserVO)) {
      ...
      collector.emit("userInfo_count_stream", new Values(new Object[] { tupleId, userVO }));
      collector.emit("userInfo_version_count_stream", new Values(new Object[] { tupleId, userVO }));
    } else if (obj != null) {
  ...
  {
    declarer.declareStream("userInfo_count_stream", new Fields(new String[] { "id", "UserInfo" }));
    declarer.declareStream("userInfo_version_count_stream", new Fields(new String[] { "id", "UserInfo" }));
  }
