...
public class AdDataShowBolt
  implements IBasicBolt
{
  private static final long serialVersionUID = -8338827981426880755L;
  private static final Logger LOG = Logger.getLogger(AdDataShowBolt.class);
  ...
  public void execute(Tuple tuple, BasicOutputCollector collector)
  {
    ...
    if ((obj instanceof AdDataVO)) {
      ...
      collector.emit("adData_show_count_stream", new Values(new Object[] { tupleId, adDataVO, adDataVO.getImei() }));
  ...
  {
    declarer.declareStream("adData_show_count_stream", new Fields(new String[] { "id", "AdData", "imei" }));
