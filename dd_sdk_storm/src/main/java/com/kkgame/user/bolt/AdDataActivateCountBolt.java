...
public class AdDataActivateCountBolt
  implements IRichBolt
{
  private static final long serialVersionUID = -7356913262243984964L;
  private static final Logger LOG = LoggerFactory.getLogger(AdDataActivateCountBolt.class);
  ...
  public void execute(Tuple input)
  {
    ...
    sb.append("adData_activate_ad_stat_times").append("_");
    sb.append(statDate);
    ...
    try {
      ...
      try { jedis.zincrby(sb.toString(), 1.0D, countSb.toString());
        ...
        if (adDataVO.getIsRepeat() == 1) { 
          sb = new StringBuffer();
          sb.append("adData_activate_ad_stat_users").append("_");
          sb.append(statDate);
          sb.append("_").append(adType);
    ...
    if ((this.dataList != null) && (this.dataList.size() >= 20)) try {
        ...
        try { sb = new StringBuffer();
          sb.append("ad_activate_data_day");
  ...
  private boolean isRepeat(AdDataVO adDataVO, boolean flag) {
    ...
    StringBuffer sb = new StringBuffer();
    String statDate = CalendarFormat.switchFormatDate(adDataVO.getCdate(), "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd");
    sb.append("adData_activate_detail").append(statDate).append("_").append(sdkStyle).append("_").append(projectId).append("_").append(channelId).append("_").append(pluginId).append("_").append(coutry).append("_").append(countryLevel).append("_").append(adType).append("_").append(adId).append("_").append(imei);
    try
    {
      Jedis jedis = this.jedisPool.getResource(); 
