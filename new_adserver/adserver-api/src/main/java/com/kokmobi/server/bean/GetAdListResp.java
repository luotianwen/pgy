...
public class GetAdListResp implements Serializable {
	...
	private List<JSONObject> gpApkInfo;
	...
	public List<JSONObject> getGpApkInfo() {
		return gpApkInfo;
	}

	public void setGpApkInfo(List<JSONObject> gpApkInfo) {
		this.gpApkInfo = gpApkInfo;
	}
