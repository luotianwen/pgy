 ...
 * @author: martins
 */
public class GetSHDisList {
    private GetSHDisList(){}
...
//            String resp = HttpUtils.sentPost("http://104.250.137.146:8081/getSHDisList", reqSB.toString());
            String resp = HttpUtils.sentPost("http://127.0.0.1:8082/getSHDisList", reqSB.toString());
            try {
