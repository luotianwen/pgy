 ...
 * @author min
 */
public class OfferSdkActiveServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(OfferSdkActiveServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{
			...
			if(null != activeInfo) {
				service.offerSdkActive(activeInfo);
			}
		}
		catch(Exception e) {
